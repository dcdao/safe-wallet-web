...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;DSafe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using DSafe</h4>
    <p>
      When visiting our website or using DSafe, we may collect and process personal data. The data will be stored in
      different instances
    </p>
    <ol>
      <li>
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the DSafe we
        process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      4.2.2 For general operational analysis of the DSafe interface, monitoring transaction origins and measuring
    ...
    <p>
      In addition, we may take a recording of you while testing DSafe for internal and external use. The basis for this
      collection and processing is our legitimate business interest in monitoring and improving our services.
    </p>
    <p>
    ...
    <p>
      DSafe mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the DSafe mobile app via biometrics information (touch ID or face ID). This is a
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with DSafe. For enhanced privacy,
      data is stored for a period of 7 days after which it is securely deleted.
    </p>
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>DSafe – Privacy policy</title>
      </Head>
