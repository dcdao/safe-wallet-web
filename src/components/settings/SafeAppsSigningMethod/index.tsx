  ...
  return (
    <Paper sx={{ padding: 4, mt: 2 }}>
      <Grid container spacing={3}>
        ...
        <Grid item xs>
          <Typography mb={2}>
            This setting determines how the DSafe will sign message requests from Safe Apps. Gasless, off-chain signing
            is used by default. Learn more about message signing{' '}
